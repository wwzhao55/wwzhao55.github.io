...
function onKeydown(e) {
    ...
    if (!EventUtil.hasClass(ulList, 'hide')) {
        ...
        searchInput.value = (ulList.dataset.listIndex == -1) ? ulList.dataset.query : ulList.childNodes[ulList.dataset.listIndex].innerHTML;
        //重新设置样式
...
window.onload = function () {
    var searchInput = document.getElementById('searchInput');
    EventUtil.addHandler(searchInput, 'input', onInput);
    EventUtil.addHandler(searchInput, 'focus', showList);
...
>>>>>>> 4f5df2b216440975a596455092483fad213b1afa
}